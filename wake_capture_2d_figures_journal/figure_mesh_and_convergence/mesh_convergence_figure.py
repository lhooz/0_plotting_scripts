...
#-------------input plot control----------
mesh_file_name = 'mesh_plate.png'
cfd_data_list = [
    'Re10000.0_stroke9.0_acf0.25_pf0.25_pa90.0_basic',
    'Re10000.0_stroke9.0_acf0.25_pf0.25_pa90.0_sc',
    'Re10000.0_stroke9.0_acf0.25_pf0.25_pa90.0_tc',
    'Re10000.0_stroke9.0_acf0.25_pf0.25_pa90.0_sctc'
]
#-----------------------------------------
legends = [
r'mesh1, $\Delta t$ = 1e-3', r'mesh2, $\Delta t$ = 1e-3',
r'mesh1, $\Delta t$ = 5e-4', r'mesh2, $\Delta t$ = 5e-4'
]
# legends = [
...
data_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(cwd))),
                        'wake_capture_2d_journal_data/1_mesh_and_convergence')
image_out_path = cwd
mesh_pic = os.path.join(data_dir, mesh_file_name)
#-----------------------------------------
cf_array = []
...
mesh_plotter(mesh_pic, image_out_path)
