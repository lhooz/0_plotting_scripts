...
#-----------------------------------------
cfd_data_list = [
    'phi60.0__ar' + '{:.1f}'.format(AR) + '_ofs0.0_r1h0.5__Re100.0_pt' + '{:.3g}'.format(pt),
    'phi120.0__ar' + '{:.1f}'.format(AR) + '_ofs0.0_r1h0.5__Re100.0_pt' + '{:.3g}'.format(pt),
    'phi160.0__ar' + '{:.1f}'.format(AR) + '_ofs0.0_r1h0.5__Re100.0_pt' + '{:.3g}'.format(pt),
    'phi180.0__ar' + '{:.1f}'.format(AR) + '_ofs0.0_r1h0.5__Re100.0_pt' + '{:.3g}'.format(pt),
]
#-----------------------------------------
legends = [
    r'$\Phi$ = 60$^\circ$',
...
show_range_cl = [-0.3, 2.5]
show_range_cd = [-1.5, 3.6]
cycle_time = 1.0
#---------------------------------------
