...
def cf_plotter90(x_data, data_array, marks, legends, x_range, y_range, y_label,
    ...
    title = 'mean lift coefficients plot ' + figname
    title2 = 'mean lift ratio plot ' + figname
    title3 = 'mean drag coefficients plot ' + figname
...
def cf_plotter0(x_data, data_array, marks, legends, x_range, y_range, y_label,
                image_out_path, figname):
    """
    function to plot cfd force coefficients results
    """
